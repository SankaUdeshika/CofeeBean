        ...
        <ol class="carousel__Viewport">
          <li class="corousel__Slide">
            <div
              ...
              style="background-image: url('img/hot-coffees.jpg');">
            </div>
            <div class="imageText">
          ...
          <li class="corousel__Slide">
            <div
              class="carousel__snapper"
              style="background-image: url('img/cold-coffees.jpg');">
            </div>
            <div class="imageText">
          ...
          <li class="corousel__Slide">
            <div
              class="carousel__snapper"
              style="background-image: url('img/frappuccino.jpg')"
            ></div>
          ...
          <li class="corousel__Slide">
            <div
              class="carousel__snapper"
              style="background-image: url('img/Mocha.png')"
            ></div>
          ...
          <li class="corousel__Slide">
            <div
              class="carousel__snapper"
              style="background-image: url('img/mojj.jpg')"
            ></div>
        ...
        <div class="item-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <label
                >Delight in our luscious chocolate frappuccino, a heavenly blend
                of flavors.</label
              >
            </div>
          </div>
        ...
        <div class="item-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3>FRAPPE</h3>
              <label
                >Discover a world of frappe flavors, from classic coffee to
                exotic blends.</label
              >
            </div>
          </div>
        ...
        <div class="item-5">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3>CAFFE MOCHA</h3>
              <label
                >Savor the harmonious blend of rich espresso and decadent
                chocolate.</label
              >
            </div>
          </div>
        ...
        <div class="item-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <label
                >Indulge in the creamy sweetness of our classic Vanilla
                Frappuccino.</label
              >
            </div>
          </div>
        ...
        <div class="item-7">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <label
                >Experience a velvety delight of our White Chocolate Mocha
                perfection.</label
              >
            </div>
          </div>
        ...
        <div class="item-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3>ICE LATTE</h3>
              <label
                >Chill with the invigorating essence of our refreshing and
        ...
        <div class="item-9">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3>ESPRESSO</h3>
              <label
                >Embrace the bold and robust flavor of our premium espresso
                shots.</label
              >
            </div>
          </div>
        ...
        <div class="item-10">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3>AMERICANO</h3>
              <label
                >Savor the simplicity of our classic Americano, a pure coffee
                essence.</label
              >
            </div>
          </div>
        ...
        <div class="item-11">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3>CAPPUCCINO</h3>
              <label
                >Indulge in a rich, creamy cappuccino for a delightful coffee
                experience.</label
              >
            </div>
          </div>
        ...
        <div class="item-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h3>MACHCHIATO</h3>
              <label
                >Experience the bold and balanced flavors of a delectable
                macchiato.</label
              >
            </div>
          </div>
